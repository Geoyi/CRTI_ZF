...
p <- plot_ly(rankImportance, x = ~reorder(Variables, Ranks), y = ~Importance, type = 'bar', text = text,
        marker = list(color = 'rgb(158,202,225)',
                      line = list(color = 'rgb(8,48,107)',
                                  width = 1.5))) %>%
  layout(title = "Variables Importance",
         xaxis = list(title = ""),
         yaxis = list(title = ""))
p
...
=====================================
![Trees and hypothesis](/Users/yizhuangfang/Dropbox/Data_Incubator_2017/Zillow_WebScraping/Trees_Hyposithis.png)


Land Use
=====================================
![Land Use Maps](/Users/yizhuangfang/Dropbox/Data_Incubator_2017/Zillow_WebScraping/Landuse_Series.png)
...
bscols(leaflet(sd) %>% addTiles() %>% fitBounds(-87.83,41.6,-87.52,42.0) %>% addCircleMarkers(~Longitude, ~Latitude, radius =2, color= ~factpal(Home_Type), popup = paste("Community:" ,df$Community, "Family Type:", df$Home_Type, sep = " ")),
